...
\section{\textcolor{airforceblue}{EMPLOYMENT EXPERIENCE}}
  ...
  {University Health Network - Toronto, ON, Canada}{2023 - 2025}
      \resumeItemListStart
            ...
            \resumeItem{Analyzed client feedback data to standardize communication protocol across departments raising satisfaction scores by 10\%}
            \resumeItem{Piloted a structured onboarding program after identifying gaps in new hire integration improving retention by 50\% and strengthened organizational continuity}
      \resumeItemListEnd
  ...
  {University Health Network - Toronto, ON, Canada}{2021 - 2023}
      \resumeItemListStart
            ...
            \resumeItem{Designed and delivered interactive training curriculum on advanced medical technologies for training physicians, strengthening clinical competency and consistency}
      \resumeItemListEnd
